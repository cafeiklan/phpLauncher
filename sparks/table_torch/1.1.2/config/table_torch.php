...
$config['table_torch_tables'] = array( 
									'ci_sessions'=>array( 'edit'=>TRUE, 'delete'=>TRUE, 'add'=>TRUE ),
									'login_attempts'=>array( 'edit'=>TRUE, 'delete'=>TRUE, 'add'=>TRUE ),
									'roles'=>array( 'edit'=>TRUE, 'delete'=>TRUE, 'add'=>TRUE ),
									'users'=>array( 'edit'=>TRUE, 'delete'=>TRUE, 'add'=>TRUE ),
									'user_autologin'=>array( 'edit'=>TRUE, 'delete'=>TRUE, 'add'=>TRUE ),
									'user_profiles'=>array( 'edit'=>TRUE, 'delete'=>TRUE, 'add'=>TRUE )
