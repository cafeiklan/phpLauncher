...
/*
|--------------------------------------------------------------------------
| Config enable firePHP or not
|
| Please make sure it's set false when your application will be online.
| usage: $this->firephp->log("log message", "debug");
|--------------------------------------------------------------------------
*/
...
|--------------------------------------------------------------------------
*/
$config['website_name'] = 'Your Website Name Here';
/*
|--------------------------------------------------------------------------
| MX modules_locations
|
| Set the location of the modules
|--------------------------------------------------------------------------
*/
...
//$config['modules_locations'] = FCPATH.'modules/';
