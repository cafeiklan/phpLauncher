...
<div class="row">
	<div class="span8">
		...
		<table class="table loginform">
			<tr>
				<td><?php echo form_label('旧密码', $old_password['id']); ?></td>
			...
			<tr>
				<td><?php echo form_label('新密码', $new_password['id']); ?></td>
			...
			<tr>
				<td><?php echo form_label('确认新密码', $confirm_new_password['id']); ?>
				</td>
			...
			<tr>
				<td></td>
				<td><?php echo form_submit('change', '修改密码'); ?></td>
				<td></td>
			</tr>
		</table>
		<?php echo form_close(); ?>
